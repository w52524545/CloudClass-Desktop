export const zh = {
  ...
  hands_up: '举手',
  on_podium_max_count: '上台人数已达上限，无法继续邀请观众上台',
  hands_up_tip: '举手请长按',
  co_video: {
    ...
    received_student_hands_up: '有观众举手了',
    received_teacher_accepted: '主持人已同意上台',
    received_teacher_refused: '主持人拒绝了上台',
    received_student_cancel: '观众取消了举手',
  ...
  error: {
    ...
    class_end: '会议已结束，请点击确定离开会议',
    unknown: '发生未知错误，错误代码: {errCode}, 信息: {message}',
    room_is_full: '当前会议已满，请点击确认离开会议',
    network_timeout: '网络请求超时',
  },
  toast: {
    mute_chat: '你已被主持人禁言了',
    unmute_chat: '你被解除禁言了',
    remote_mute_chat: '{studentName}被主持人禁言了',
    remote_unmute_chat: '{studentName}被主持人解除禁言了',
    add_screen_share: '主持人开启了屏幕共享',
    remove_screen_share: '主持人关闭了屏幕共享',
    granted_board_success: '授权白板成功',
    revoke_board_success: '收回白板成功',
    create_screen_share_failed: '创建屏幕分享失败',
    kick_by_other_side: '当前用户重复进入会议，您已离开会议',
    screen_share: {
      title: '屏幕共享',
    },
    close_ppt: '关闭当前课件',
    ...
    end_class: '会议已结束',
    quit_from_room: '离开会议',
    kick_by_teacher: '你已被踢出会议',
    upload_log_failure: '上传日志失败，错误类型：{reason}, 详情参考开发者工具',
    show_log_id: `请提供你的日志ID: {no}`,
    api_login_failured: '会议加入失败, 原因: {reason}',
    confirm: '确定',
    cancel: '取消',
    leave_room: '离开会议',
    quit_room: '确定退出会议吗？',
    AutoStartBeforeClass: '会议未开始不能操作，点确定将自动开始，确定开始吗！',
    CallTeacherBeforeClass: '当前会议未开始不能操作，请联系主持人开始会议！',
    ConfirmEndClass: '确定要结束会议吗？',
    login_failure: '登录会议失败',
    whiteboard_lock: '设置白板跟随',
    whiteboard_unlock: '取消白板跟随',
    OpenAfterOpenWhiteBoard: '请先打开白板才能进行操作！',
    ...
    rtm_login_failed: '会议登录失败, 请检查网络设置',
    rtm_login_failed_reason: '会议登录失败, 原因： {reason}',
    replay_failed: '回放失败，请刷新页面重试',
    teacher_exists: '该会议主持人已存在，请等待30秒或重新创建会议',
    student_over_limit: '超出观众最大人数，请等待30秒或重新创建会议',
    teacher_and_student_over_limit: '超出观众和主持人的最大人数',
    teacher_accept_whiteboard: '主持人已授权了你白板的权限',
    teacher_cancel_whiteboard: '主持人已收回了你白板的权限',
    teacher_accept_co_video: '主持人已允许连麦',
    teacher_reject_co_video: '主持人已拒绝连麦',
    teacher_cancel_co_video: '主持人已取消连麦',
    student_cancel_co_video: '观众已取消连麦',
    student_send_co_video_apply: '"{reason}" 观众发起了连麦申请',
    student_peer_leave: '"{reason}" 离开了',
    stop_co_video: '主持人停止了"{reason}"的连麦',
    reject_co_video: '您取消了观众的连麦申请',
    close_co_video: '您关闭了观众的连麦',
    close_youself_co_video: '你关闭了自己的连麦',
    accept_co_video: '您同意了连麦',
    successfully_joined_the_room: '加入会议成功',
    failed_to_join_the_room: '加入会议失败',
    ...
    i: '我',
    teacher: '主持人',
    the_teacher_authorized_your_whiteboard: '主持人授权了你的白板',
    the_teacher_cancelled_your_whiteboard_permission: '主持人取消了你的白板权限',
    ...
    course_started_successfully: '会议开始成功',
    setting_start_failed: '设置开始失败',
    the_course_ends_successfully: '会议结束成功',
    ...
    the_teacher_agreed: '主持人同意了',
    student_applied: '观众申请了',
    you_were_dismissed_by_the_teacher: '你被主持人下麦了',
    student_canceled: '观众取消了',
    the_teacher_refused: '主持人拒绝了',
    ...
    classroom_remote_join: '账号在其他设备登录，您已离开会议',
    time_interval_between_start: `距离开始会议开始还有: {reason}分钟`,
    time_interval_between_end: `会议还有{reason}分钟结束`,
    class_is_end: `结束会议咯，会议还有{reason}分钟关闭`,
    time_interval_between_close: `会议还有{reason}分钟关闭`,
  ...
  pretest: {
    ...
    teacher_device_may_not_work: '主持人视频可能出现问题！',
  },
  'biz-header': {
    perf: 'Perf',
    setting: '设置',
  ...
  nav: {
    ...
    class_start: '会议开始',
    back: '返回',
    to_start_in: '距离开始会议还有：',
    started_elapse: '已开始会议：',
    ended_elapse: '已结束会议：',
    class_not_started: '会议未开始',
    hours: '小时',
    minutes: '分钟',
    seconds: '秒',
    ms: '毫秒',
  ...
  stream: {
    ...
    'placeholder.notpresent.teacher': '主持人不在会议',
    'placeholder.notpresent.student': '观众不在会议',
  },
  screenshare: {
    display: '屏幕{reason}',
  },
  toast2: {
    'teacher.turn.off.my.mic': '主持人已关闭你的麦克风，你暂时不能发言了',
    'teacher.turn.on.my.mic': '主持人已打开你的麦克风，你可以开始发言了',
    'teacher.turn.off.my.cam': '主持人已关闭你的摄像头',
    'teacher.turn.on.my.cam': '主持人已打开你的摄像头',
    'teacher.grant.permission': '你已被主持人授权，请使用白板工具互动',
    'teacher.revoke.permission': '你已被主持人收回授权，无法使用白板工具互动',
    'teacher.accept.onpodium': '主持人邀请你上台了，与大家积极互动吧',
  ...
  breakout_room: {
    ...
    confirm_ask_for_help_absent_content: '主持人不在会议中',
    ...
    confirm_stop_group_content: '结束后，所有学员将返回大会议',
    ...
    group_number: '讨论组个数',
    group_type: '分配方式',
    group_tips: '将会议内容复制到讨论组',
    user_panel_empty: '暂无可分配观众',
    group_current_has_students: '{reason}人',
    group_current_empty: '暂无观众',
  },
  /** Breakout Room  */
  fcr_group_help_title: '请求帮助',
  fcr_group_help_content: '你可以邀请主持人进入小组帮助你',
  fcr_group_help_teacher_busy_msg: '主持人正在忙，请稍后重试',
  fcr_group_teacher_is_helping_others_msg: '	主持人正在帮助其他讨论组，请稍后重试',
  fcr_group_teacher_exist_hint: '主持人已在小组内',
  fcr_group_invite: '邀请',
  fcr_group_invitation: '主持人邀请您加入{reason}',
  ...
  fcr_group_close_group: '主持人结束了小组讨论',
  fcr_group_invite_back_main_room: '主持人邀请你回到大会议',
  fcr_group_back_main_room: '正在回到大会议...',
  fcr_group_back_sure: '确定',
  fcr_group_back_cancel: '取消',
  fcr_group_back_exit: '退出',
  fcr_group_back_to_main_room: '回到大会议',
  fcr_group_exit_room: '离开会议',
  fcr_group_student_not_in_room: '用户未进入分组',
  fcr_group_sure: '确定',
  /** Breakout Room  */
  /** Remote Control */
  fcr_share_title_teacher: '主持人屏幕共享',
  fcr_share_title_singel_window: '支持单个窗口共享',
  fcr_share_title_full_screen: '支持全屏共享',
  fcr_share_title_sound: '不支持声音',
  fcr_share_title_all_student: '观众屏幕共享',
  fcr_share_title_any_student: '可指定任意观众屏幕',
  fcr_share_selected: '已选择{reason}',
  fcr_share_sharing: '正在分享{reason}屏幕',
  fcr_share_authorized_control: '主持人已授权你控制屏幕',
  fcr_share_forbidden_control: '主持人已回收你的屏幕控制权',
  fcr_share_device_not_support: '{reason} 开始会议设备不支持远程控制',
  fcr_share_Remote_control_disconnected: '{reason} 离开会议，已断开远程控制权',
  fcr_share_reminded_student_agree:
    '{reason1} 尚未同意共享屏幕，提醒{reason2} 单击“同意”按钮共享自己的屏幕',
  fcr_share_teacher_requesting_share: '主持人正在请求分享并操作你的屏幕，请选择同意或暂不处理',
  fcr_share_stopped_student_share: '主持人已停止共享你的屏幕',
  fcr_share_no_student: '当前会议没有观众，无法开启观众屏幕共享',
  fcr_share_device_no_support: '观众设备不支持远程控制，无法开启观众屏幕共享',
  fcr_rc_control_bar_allow_student_control: '允许{reason}控制',
  fcr_rc_control_bar_disallow_student_control: '不允许观众控制',
  ...
  fcr_vocational_teacher_absent: '主持人当前不在会议中',
  fcr_vocational_video_start_early_alert: '提前开始会议将立即播放会议录像，是否确认？',
  ...
  edu_serv_error: {
    ...
    '20401001': '此角色不能加入会议',
    '20403001': '会议内该角色人数已达上限，无法进入',
    '20403002': '会议人数已达上限，无法进入',
    '20404000': '进程不存在',
    '20404100': '会议不存在',
    '20410101': '会议已过期',
    '20404200': '用户不存在',
  ...
  invite: {
    ...
    confirm: {
      title: '提示',
      content: '主持人邀请你上台交流，点击确定上台 点击取消忽略',
      ok: '确认',
      cancel: '取消',
    },
  },
