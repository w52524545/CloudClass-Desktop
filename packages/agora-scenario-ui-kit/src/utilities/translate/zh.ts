export const zh = {
  ...
  toast: {
    ...
    teacher_exists: '该房间主持人已存在，请等待30秒或重新创建教室',
    student_over_limit: '超出观众最大人数，请等待30秒或重新创建教室',
    ...
    class_is_end: `结束会议咯，教室还有{reason}分钟关闭`,
  ...
  stream: {
    ...
    'placeholder.notpresent.teacher': '主持人不在教室',
    'placeholder.notpresent.student': '观众不在教室',
  },
  screenshare: {
    display: '屏幕{reason}',
  },
  ...
  breakout_room: {
    ...
    confirm_ask_for_help_absent_content: '主持人不在教室中',
  ...
  fcr_group_invite_back_main_room: '主持人邀请你回到大房间',
  ...
  fcr_share_no_student: '当前教室没有观众，无法开启观众屏幕共享',
  ...
  fcr_vocational_teacher_absent: '主持人当前不在教室中',
  fcr_vocational_video_start_early_alert: '提前开始会议将立即播放课程录像，是否确认？',
